...
/*
$(".bt0 input").onchange(function() {
	var searchBarInput = document.getElementById("bt0_orderID");
...
function testAjax() {
	...
	$.ajax({
		...
		success:function(data) {
			if (data != 0) {
				productArray = jQuery.parseJSON(data);
...
autocomplete(document.getElementById("bt0_orderID"), productArray);
